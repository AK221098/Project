...
<body class="hold-transition login-page">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-mini" style="color:white;"><b>J</b>P</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg" style="color:white;">HDU <b>Job</b> Portal</span>
    </a>
    ...
    <!--<div class="row">
      <div class="col-md-4">
        <img src="img/images.jpg" class="img-responsive"  width='200' height='100'>
      </div>
    </div>
-->
<div class="login-box">
