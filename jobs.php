...
<body class="hold-transition skin-green sidebar-mini" background="C:\wamp64\www\Job-Portal\img\job_search.jpg">
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg">CsStudio <b>Job</b> Portal</span>
    </a>
                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      <li><a href=""  class="citySearch" data-target="Greater Mamchester"><i class="fa fa-circle-o text-yellow"></i> Mamchester</a></li>
                      <li><a href=""  class="citySearch" data-target="Glasgow"><i class="fa fa-circle-o text-yellow"></i> Glasgow</a></li>
                      <li><a href=""  class="citySearch" data-target="Birmingham"><i class="fa fa-circle-o text-yellow"></i> Birmingham</a></li>
                      <li><a href=""  class="citySearch" data-target="Greater London"><i class="fa fa-circle-o text-yellow"></i> London</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2017-2018 <a href="index.php">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
