...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg">Job-Portal <b>Job</b></span>
    </a>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2019-2020 <a href="index.php">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
